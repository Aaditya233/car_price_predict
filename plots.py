...
def app(car_df):
    ...
    if "Histogram" in plot_types:
        ...
        columns = st.selectbox("select colums to draw histogram",("carwidth","enginesize","horsepower"))
    ...
    if "Box Plot"in plot_types :
        ...
        columns = st.selectbox("select colums to draw boxplot ",("carwidth","enginesize","horsepower"))
    ...
    if "Correlation Heatmap"in plot_types:
        ...
        ax.set_ylim(bottom+0.5,top-0.5) # Creating an object of seaborn axis and storing it in 'ax' variable
        # Getting the top and bottom margin limits.
         # Increasng the bottom and decreasing the bottom margins respectively.
        st.pyplot()